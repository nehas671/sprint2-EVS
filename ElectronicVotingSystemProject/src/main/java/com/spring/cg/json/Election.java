...
public class Election {
	...
	public Election(Long electionId, String election_name, String state, String constituency,  LocalDate date) {
		super();
	...
	public Election(Long electionId, String election_name, String state, String constituency,  LocalDate date,Set<Partys> parties) {
		super();
		this.electionId = electionId;
		this.electionName = election_name;
		this.state = state;
